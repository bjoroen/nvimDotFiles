...
local palette = {
	...
	purple = { gui = "#566981", cterm = 103 },
	red = { gui = "#A54242", cterm = 167 },
	orange = { gui = "#f39967", cterm = 173 },
	yellow = { gui = "#F0C674", cterm = 173 },
...
Group.new("NormalFloat", c.white, c.backgnd, s.none)
...
Group.link("TelescopeSelection", g.SitrusYellow)
...
Group.new("IblIndent", g.SitrusGray)
Group.new("IblScope", g.SitrusPurple)
...
Group.link("@float", g.NormalFloat)
...
Group.link("@lsp.type.enumMember", g.Header)
...
-- Color.new("string", "#a6e3a1")
-- Color.new("graa", "#949494")
-- Color.new("type_rust", "#f39967")
